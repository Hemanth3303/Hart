...
// #define HART_ENGINE_VERSION_PRERELEASE_TAG "<prerelease-tag>"
// #define HART_ENGINE_VERSION_BUILD_META_DATA "<build-meta>"

	#if defined(HART_ENGINE_VERSION_PRERELEASE_TAG) && defined(HART_ENGINE_VERSION_BUILD_META_DATA)
		#define HART_ENGINE_VERSION_SUFFIX "-" HART_ENGINE_VERSION_PRERELEASE_TAG "+" HART_ENGINE_VERSION_BUILD_META_DATA
	#elif defined(HART_ENGINE_VERSION_PRERELEASE_TAG)
		#define HART_ENGINE_VERSION_SUFFIX "-" HART_ENGINE_VERSION_PRERELEASE_TAG
	#elif defined(HART_ENGINE_VERSION_BUILD_META_DATA)
		#define HART_ENGINE_VERSION_SUFFIX "+" HART_ENGINE_VERSION_BUILD_META_DATA
	#endif

	#if defined(HART_ENGINE_VERSION_SUFFIX)
	...
	#define HART_COMPILATION_TIMESTAMP __DATE__ " at " __TIME__ " (compiled host's localtime)"
		...
		#endif
	#elif defined(HART_COMPILER_LLVM_CLANG)
