...
namespace Hart {
	...
	inline const Vec4 Gray = { 0.5f, 0.5f, 0.5f, 1.0f };
	inline const Vec4 Orange = { 1.0f, 0.65f, 0.0f, 1.0f };
	inline const Vec4 Purple = { 0.5f, 0.0f, 0.5f, 1.0f };
	inline const Vec4 Pink = { 1.0f, 0.74f, 0.8f, 1.0f };
	inline const Vec4 Brown = { 0.65f, 0.32f, 0.16f, 1.0f };
	inline const Vec4 Teal = { 0.0f, 0.5f, 0.5f, 1.0f };
	inline const Vec4 Silver = { 0.75f, 0.75f, 0.75f, 1.0f };
	inline const Vec4 Gold = { 1.0f, 0.84f, 0.0f, 1.0f };
