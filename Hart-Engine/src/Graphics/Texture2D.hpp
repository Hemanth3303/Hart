...
namespace Hart {
	namespace Graphics {
		...
		public:
			...
			Texture2D(uint32_t* buffer, int32_t width, int32_t height, int32_t noOfChannels = 4, GLint magFilterParam = GL_LINEAR, GLint minFliterParam = GL_LINEAR_MIPMAP_LINEAR);
			~Texture2D();
