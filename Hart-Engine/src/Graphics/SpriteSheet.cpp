...
namespace Hart {
	SpriteSheet::SpriteSheet(const Image& image, const Vec2& spriteSize, TextureMagFilter magFilter, TextureMinFilter minFiler)
	...
	SpriteSheet::SpriteSheet(const std::string& filePath, const Vec2& spriteSize, TextureMagFilter magFilter, TextureMinFilter minFiler)
		: m_SpriteSize(spriteSize) {
